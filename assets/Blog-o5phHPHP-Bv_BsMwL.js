import{R as s,A as q,j as e,C as L}from"./index-DGaT_JMp.js";import{T as H,u as X,h as G,l as U,a as W,y as J}from"./index.esm-Dqt17Ohr-DAmIDVFL.js";import{d as K,i as O}from"./firebaseConfig-BqIL-e7F-D0kZRQGD.js";import{s as Q}from"./Footer-C4lV-gcO-qWMED4Ci.js";function te(){const[B,A]=s.useState([]),[o,I]=s.useState([]),[v,w]=s.useState(!0),[T,C]=s.useState(!1),[j,c]=s.useState(0),[y,n]=s.useState(!0),S=q(),$=s.useRef(null),g=s.useRef(null);s.useEffect(()=>{document.title="Blog | Manuja Dayawansha",window.scrollTo(0,0);const a=H(K,t=>{const i=document.getElementById("loginbtn"),d=document.getElementById("loginpenal");t&&i&&d&&(i.style.display="none",d.innerHTML=`
          <img src="${t.photoURL}" 
