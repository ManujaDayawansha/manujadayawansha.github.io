import{r as a,a as e}from"./index-Ct4-AMDH.js";import{H as B}from"./Header-CRfkuGsj.js";import{F as H}from"./Footer-DaPdHxkB.js";import"./index.esm-xksvQSJL.js";import"./firebaseConfig-BkiWjMfe.js";const I=`
...
`;function V({company:o,tagline:i,email:t,phone:n,website:s}){return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"gradient-bar"}),e.jsxs("div",{className:"letter-header",children:[e.jsxs("div",{children:[e.jsx("div",{className:"company-name",children:o||"Company Name"}),i&&e.jsx("div",{className:"company-tagline",children:i}),e.jsxs("div",{className:"header-badge",children:["Est. ",new Date().getFullYear()]})]}),e.jsxs("div",{className:"header-contact",children:[t&&e.jsxs("span",{children:["✉ ",t]}),n&&e.jsxs("span",{children:["✆ ",n]}),s&&e.jsxs("span",{children:["⊕ ",s]})]})]})]})}function Y({company:o,address:i,confidential:t}){const n=new Date().getFullYear();return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"letter-footer",children:[e.jsx("div",{className:"footer-left",children:i||"123 Business Ave"}),e.jsxs("div",{className:"footer-center",children:[e.jsx("span",{className:"footer-center-dot"}),t?"Strictly Confidential":`© ${n} ${o||"Company"}`,e.jsx("span",{className:"footer-center-dot"})]}),e.jsxs("div",{className:"footer-icons",children:[e.jsx("span",{className:"footer-icon",children:"✉"}),e.jsx("span",{className:"footer-icon",children:"⊕"})]})]}),e.jsx("div",{className:"gradient-bar"})]})}const y={Indigo:{start:"hsl(224,75%,65%)",end:"#4f46e5"},Violet:{start:"#7c3aed",end:"#a855f7"},Rose:{start:"#e11d48",end:"#f43f5e"},Teal:{start:"#0d9488",end:"#06b6d4"},Amber:{start:"#d97706",end:"#f59e0b"},Slate:{start:"#475569",end:"#64748b"}};function q(){const[o,i]=a.useState("Indigo"),[t,n]=a.useState("Harlow & Associates"),[s,j]=a.useState("Strategic Consulting Group"),[d,N]=a.useState("hello@harlow.co"),[c,k]=a.useState("+1 (212) 555-0190"),[p,z]=a.useState("www.harlow.co"),[x,S]=a.useState("280 Park Avenue, New York NY 10017"),[m,M]=a.useState("Ms. Eleanor Voss"),[g,C]=a.useState(`Director of Partnerships
Voss Capital Group
London, EC2V 8RF`),[h,E]=a.useState("Dear Ms. Voss,"),[f,D]=a.useState(`We are pleased to present this proposal in response to your recent inquiry regarding strategic advisory services for the upcoming fiscal year.
