import{R as t,j as r}from"./index-CEf5fZ-s.js";import{j as p}from"./Header-CBGAUW2V-DYfveAGl.js";import{s as x}from"./Footer-C4lV-gcO-D8jxKnl_.js";import"./index.esm-Dqt17Ohr-DAmIDVFL.js";import"./firebaseConfig-BqIL-e7F-D0kZRQGD.js";const S=()=>{const[a,s]=t.useState(`<div class="container-template">
  <h1>Hello World!</h1>
  <p>Start editing to see changes instantly.</p>
  <button class="btn-template">Click Me</button>
</div>`),[l,n]=t.useState(`/* ==================== VARIABLES CSS ==================== */
:root {
  --header-height: 3rem;
  --font-semi: 600;
  --font-bold: 700;
...
}`),[i,c]=t.useState(`// JavaScript Code
...
if (btn) {
  btn.addEventListener('click', () => {
    alert('Button clicked!');
...
}`),[e,d]=t.useState("html"),[b,m]=t.useState("");t.useEffect(()=>{const o=setTimeout(()=>{m(`
        <!DOCTYPE html>
        <html>
          <head>
            <style>${l}</style>
      ...
      `)},250);return()=>clearTimeout(o)},[a,l,i]);const h=[{id:"html",label:"HTML",icon:"📄"},{id:"css",label:"CSS",icon:"🎨"},{id:"js",label:"JS",icon:"⚡"}],f=()=>{switch(e){case"html":return a;case"css":return l;case"js":return i;default:return""}},g=o=>{switch(e){case"html":s(o);break;case"css":n(o);break;case"js":c(o);break}};return r.jsxs("div",{style:{minHeight:"100vh",background:"var(--body-color)",color:"var(--text-color)",fontFamily:"var(--body-font)",padding:"1rem"},children:[r.jsx("style",{children:`
        :root {
          --header-height: 3rem;
          --font-semi: 600;
          --font-bold: 700;
